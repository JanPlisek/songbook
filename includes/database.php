...
$db_name = 'plisek';   // Název databáze, kterou jsme právě vytvořili

$username = 'plisek';        // Výchozí uživatel pro XAMPP

$password = 'r7feDXNq_9B';            // Výchozí heslo pro XAMPP je prázdné
